...
MVVM(Model View ViewModel) ejemplo en Kotlin usando los componentes : ViewModel, LiveData y Coroutines, las bibliotecas Retrofit, Gson,  Glide y OKttp. Además,sealed class para reemplazar callbacks. Finalmente, para testing: Mockito, coroutines y flow.
