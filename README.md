...
MVVM(Model View ViewModel) sample in Kotlin using the components ViewModel, LiveData, the libraries Retrofit also Glide. Also, sealed classes to replace callbacks. Finally for testing, Mockito and Coroutines.
